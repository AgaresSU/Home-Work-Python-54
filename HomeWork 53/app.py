...
plumbuses = [
    {
        ...
        "info": "Самый частый вариант для дома. Его проще всего проверить и почистить.",
    },
    {
        "name": "Офисный плюмбус",
        "info": "Используется чаще, поэтому ему нужна регулярная проверка.",
    },
    {
...
advice = [
    "Если плюмбус стал выглядеть грустно, его лучше отнести в сервис.",
