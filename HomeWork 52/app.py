...
facts = [
    ...
    "Скорее всего, это что-то для дома.",
    "От него ждут больше комфорта.",
    "Кто его придумал, не совсем понятно.",
]

plumbuses = [
    {
        "name": "Обычный плюмбус",
        "text": "Самый обычный вариант, его можно представить почти в любой комнате.",
        "price": "6 1/2 бряблов",
    },
    {
        "name": "Офисный плюмбус",
        "text": "Больше подходит для рабочего места, хотя точно сказать сложно.",
        "price": "8 бряблов",
    },
    {
        "name": "Подарочный плюмбус",
        "text": "Выглядит аккуратнее, поэтому его можно подарить.",
        "price": "10 бряблов",
    },
]
...
steps = [
    ...
    "Дингльбоб нанизывается на грумбу.",
